...
let books = JSON.parse(localStorage.getItem('books')) || [
  ...
  },
  {
    ...
    "author": "林禹瑄",
    "presenter": "紆里",
    "summary": "久住歐陸的林禹瑄，以移居、遷徙的眼光看望擁有過的街、城、邊境，並反溯家鄉——身分裡的身分，生活無絕對的晴朗，記憶亦然。",
    "reviews": [
      {
        "id": 1,
        "reviewer": "抽抽",
        "rating": 3,
        "comment": "我覺得我用很造孽的方式在翻詩，我知道詩可能不應該這樣看過去，但我就是看了一首後想說「嗯？有點不懂，下一首可能會看得懂！」然後就一直迫不及待的往下翻，翻著翻著就翻完了（\n裡面我最喜歡的是跟書名同名的那篇〈春天不在春天街〉，不知道是不是因為是講母親，所以我比較有共鳴感。",
        "fullReviewUrl": "https://www.dropbox.com/scl/fi/lvpntc2ug8msk3r1u3ihq/.paper?rlkey=6cnwjn1s52b6o6ue7a82t5t6e&dl=0"
      },
      {
        "id": 2,
        "reviewer": "紆里",
        "rating": 4,
        "comment": "這本詩集像是某個與我相近之人的一生，是對『不在場』感受的收容；雖然我無法完全共感，但它仍觸動了我對記憶、存在與詩的理解方式。",
        "fullReviewUrl": "https://docs.google.com/document/d/1KadrM7GzKN7XFWbuDr0IHy5Zpk3DEqiJnItiiawugJE/edit?tab=t.0"
      },
      {
        "id": 3,
        "reviewer": "Inlin",
        "rating": 5,
        "comment": "這本對現在的我而言，意外成為了一個好的讀詩入門體驗。因為可以從過程中感覺到，作者曾經看見過的政治事件，他歷經的時光他寫下來，然後讓我看見，我很訝異自己發現確實我大概明白他在說什麼。",
        "fullReviewUrl": "https://docs.google.com/document/d/1H23-blor5QybFEJNn5JxtmcXo_OeO7adDOqcQrM3_tE/edit?tab=t.0"
      },
      {
        "id": 4,
        "reviewer": "SL",
        "rating": 3,
        "comment": "為了寫感想再重讀了一遍，覺得整本書的詩帶給我一種與世隔絕的寂寞感吧。",
        "fullReviewUrl": "https://docs.google.com/document/d/1Rlm16A5rxN74jH3PR3BVdj91NbppqVFMZs7-UUKErQA/edit?tab=t.0"
      }
    ]
  },
  {
    ...
    "author": "林清玄",
    "presenter": "三三",
    "summary": "林清玄以有情的眼光看世間，在人心與潮流競走的年代，尋找內在最和諧的共鳴，頂住社會的輕忽與善忘。",
    "reviews": [
      {
        "id": 1,
        "reviewer": "抽抽",
        "rating": 2,
        "comment": "我覺得作者文筆的確滿好的，說故事時有個獨特的節奏跟風格，有點老氣但應該很合某年代區間人的口味。可惜故事內容雖然說總說佛法總說清淨，總說著遠離塵囂，但實際上讀起來莫名的很像凡爾賽文學。",
        "fullReviewUrl": "https://www.dropbox.com/scl/fi/zzbjbci5zm0g4vzh01s54/.paper?rlkey=y6yggekhaq39vqu4jdfgrt4s8&dl=0"
      },
      {
        "id": 2,
        "reviewer": "Inlin",
        "rating": 4,
        "comment": "雖然我無法認同作者的價值觀與傲慢，但透過他的文字，我看見了他人生中閃閃發亮的事物。",
        "fullReviewUrl": "https://docs.google.com/document/d/1xdG-kKezXRndsGyYwFw-WFk7k0akwESwYCayRG3-EcI/edit?tab=t.0"
      },
      {
        "id": 3,
        "reviewer": "SL",
        "rating": 2,
        "comment": "覺得好久沒有看到這麼像國文課本的文章了，大概也可以想像為什麼作者會說他的文章經常被收錄在課文裡，勸世說教感真重啊。",
        "fullReviewUrl": "https://docs.google.com/document/d/1UAnNsFwF5ku5V_Bc_jknz_mJXhRKIDPdRusPQz1qVNY/edit?tab=t.0"
      }
    ]
  },
  {
    ...
    "reviews": [
      {
        ...
        "reviewer": "抽抽",
        "rating": 5,
        "comment": "看完後覺得文豪不愧是文豪，真的都好會寫文（廢話）\n總之看完覺得滿開心的，是類型相異讓人各方面都很滿足的短篇們",
        "fullReviewUrl": "https://www.dropbox.com/scl/fi/s4s62ztyrlop69zvy9ebq/.paper?rlkey=z0ep8v7p46fw5bry4thi6h95f&dl=0"
      },
      {
        "id": 2,
        "reviewer": "Inlin",
        "rating": 5,
        "comment": "果然日本文豪的作品由於很多短篇，很適合這種搭配解說賞析能一起看的形式！之前我大概是買過芥川文選時買過這種有附賞析的，但說實話我斷然更喜歡這本以推理話題的角度講話。",
        "fullReviewUrl": "https://docs.google.com/document/d/15PkkaYQ2isaRm2LYqQvsh7EnBImfAQ30ZHhfba9MT-0/edit?tab=t.0"
      },
      {
        "id": 3,
        "reviewer": "SL",
        "rating": 5,
        "comment": "有幾篇小說其實覺得比較像是推理小說的要素而不是推理小說，但想到那時候日本的推理小說也還在發展當中，而作者本人搞不好也不是本著寫推理小說的心來寫的作品，所以要求這個或許也是不近情理。",
        "fullReviewUrl": "https://docs.google.com/document/d/1k1MvesCsloZd2-if22w6TUebS65jAehCsm83ChY8NYg/edit?tab=t.0"
      },
      {
        "id": 4,
        "reviewer": "藍",
        "rating": 5,
        "comment": "因為都是短篇所以有點難發表感想，不過所有的文章內容都蠻有趣的，不會特別覺得哪一篇力道不夠又或是無趣，不愧是文豪們？因為都是短篇所以看起來也很輕鬆，個人感覺如果日常慢慢的分次配飯閱讀的話說不定會很舒服，只不過我一次看完了。每一篇的短篇後都會有解說，看這些解說介紹也有種獲得其中小知識的感覺，所以還不錯。",
        "fullReviewUrl": "https://notes.underxheaven.com/preview/49d92f7c9315a0d6747aa0c7ae6a2823"
      }
    ]
  },
  {
    ...
    "author": "內佛．舒特",
    "presenter": "仙草",
    "summary": "第三次世界大戰爆發後，核能武器在短短一個月摧毀了世界，北半球歸於沉寂，而輻射塵正以死神的腳步慢慢飄向南方的澳洲。",
    "reviews": [
      {
        "id": 1,
        "reviewer": "抽抽",
        "rating": 4,
        "comment": "一開始有點抓不到重點，但隨著故事進入日常場景，那種寧靜迎接死亡的氛圍漸漸浮現，慢步調的末日敘事讓我感受到一種文學性的特別。",
        "fullReviewUrl": "https://www.plurk.com/p/3hfsc450dp"
      }
    ]
  },
  {
    ...
    "author": "艾蜜莉．孟德爾",
    "presenter": "凜苑",
    "summary": "「在後疫情時代重讀《如果我們的世界消失了》，可能一方面不寒而慄於書中許多充滿先見之明的疫病景觀，但一方面也慶幸我們的世界並不如小說一般消失。",
    "reviews": [
      {
        "id": 1,
        "reviewer": "抽抽",
        "rating": 1,
        "comment": "好難看，文字浮誇但背景設定根本一蹋糊塗，導致變得很矯揉造作。\n讀起來覺得作者像是沒在乎過世界的人卻寫得好像深愛這個世界讓人困惑，多關心一點政治吧。",
        "fullReviewUrl": null
      }
    ]
  }
